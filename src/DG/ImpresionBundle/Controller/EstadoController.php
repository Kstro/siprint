...
use DG\ImpresionBundle\Entity\Estado;
use DG\ImpresionBundle\Form\EstadoType;
...
class EstadoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $estados = $em->getRepository('DGImpresionBundle:Estado')->findAll();
    ...
    {
        $estado = new Estado();
        $form = $this->createForm('DG\ImpresionBundle\Form\EstadoType', $estado);
    ...
    {
        $deleteForm = $this->createDeleteForm($estado);
        $editForm = $this->createForm('DG\ImpresionBundle\Form\EstadoType', $estado);
