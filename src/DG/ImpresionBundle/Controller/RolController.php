...
use DG\ImpresionBundle\Entity\Rol;
use DG\ImpresionBundle\Form\RolType;
...
class RolController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $rols = $em->getRepository('DGImpresionBundle:Rol')->findAll();
    ...
    {
        $rol = new Rol();
        $form = $this->createForm('DG\ImpresionBundle\Form\RolType', $rol);
    ...
    {
        $deleteForm = $this->createDeleteForm($rol);
        $editForm = $this->createForm('DG\ImpresionBundle\Form\RolType', $rol);
