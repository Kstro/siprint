...
//        $historial = new HistorialClinico();
     ...
     * @return \Symfony\Component\Form\Form The form
     */
    private function createCreateFormEstetica(Consulta $entity,$tipo,$identidad)
    {
        if($tipo==1){
            $form = $this->createForm(new ConsultaType(), $entity, array(
                'action' => $this->generateUrl('admin_consulta_estetica_create', array('id' => 1,'identidad'=>$identidad)),
                'method' => 'POST',
            ));
        }
     ...
     * Displays a form to create a new Consulta entity.
     *
     * @Route("/estetica/nueva", name="admin_nueva_consulta_estetica")
     * @Method("GET")
     * @Template("DGPlusbelleBundle:Consulta:new_consulta_estetica.html.twig")
     */
    public function newConsultaEsteticaAction()
    {
        $entity = new Consulta();
        //Recuperación del paciente
        $request = $this->getRequest();
